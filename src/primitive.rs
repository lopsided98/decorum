...
impl Encoding for f32 {
    const MAX_REAL: Self = f32::MAX;
    const MIN_REAL: Self = f32::MIN;
    const MIN_POSITIVE_REAL: Self = f32::MIN_POSITIVE;
...
impl Encoding for f64 {
    const MAX_REAL: Self = f64::MAX;
    const MIN_REAL: Self = f64::MIN;
    const MIN_POSITIVE_REAL: Self = f64::MIN_POSITIVE;
